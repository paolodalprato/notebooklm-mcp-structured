...
import { buildStructuringGuidelines } from "../templates/structuring-guidelines.js";
...
export function buildAskQuestionDescription(library: NotebookLibrary): string {
  ...
  // Structuring guidelines from external template
  const structuringGuidelines = buildStructuringGuidelines(bt);
